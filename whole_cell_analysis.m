...
%% create settings tab
    % create and populate the tab that initializes analysis and contains analysis settings

    % create tab and store dimensions for later use
    controlTab = uitab('Parent',buttonTabGroup,...
        'Title','Options');
    controlTabDims = controlTab.Position;
    controlTabWidth = controlTabDims(3);
    controlTabHeight = controlTabDims(4);
    
    % list boxes containing experiments, recording files, and existing analysis files
    uilabel('Parent',controlTab,...
        'Text','Choose an experiment',...
        'HorizontalAlignment','Center',...
        'Position',[controlTabWidth*0.15-(175/2) controlTabHeight*0.775 175 40],...
        'fontweight', 'bold');
    directoryControl = uilistbox('Parent',controlTab,...
        'Items',dirliststrings,...
        'ValueChangedFcn',@populateLists,...
        'Position',[controlTabWidth*0.15-(150/2) controlTabHeight*0.65-(75/2) 150 75]);
    uilabel('Parent',controlTab,...
        'Text',sprintf('%s\n%s','Choose a trace',' to begin analysis'),...
        'HorizontalAlignment','Center',...
        'fontweight', 'bold',...
        'Position',[controlTabWidth*0.5-(175/2) controlTabHeight*0.775 175 40]);
    mainTraceControl = uilistbox('Parent',controlTab,...
        'Items',traceliststrings,...
        'Position',[controlTabWidth*0.5-(150/2) controlTabHeight*0.65-(75/2) 150 75]);
    uilabel('Parent',controlTab,...
        'Text',sprintf('%s\n%s','Choose an existing','file to resume analysis'),...
        'HorizontalAlignment','Center',...
        'fontweight', 'bold',...
        'Position',[controlTabWidth*0.85-(200/2) controlTabHeight*0.775 200 40]);
    analysisList = uilistbox('Parent',controlTab,...
        'Items',matliststrings,...
        'Position',[controlTabWidth*0.85-(150/2) controlTabHeight*0.65-(75/2) 150 75]);
    
    % controls for measuring and editing RMS/noise threshold
    uibutton('Parent',controlTab,...
        'Text','Measure',...
        'ButtonPushedFcn',@measureRMS,...
        'fontweight', 'bold',...
        'Position',[controlTabWidth*0.08-(60/2) controlTabHeight*0.405 60 20]); 
    uilabel('Parent',controlTab,...
        'Text','RMS =',...
        'fontweight', 'bold',...
        'HorizontalAlignment','Center',...
        'Position',[controlTabWidth*0.16-(50/2) controlTabHeight*0.4 50 20]);
    rmsField = uieditfield(controlTab,...
        'numeric',...
        'Value',RMS,...
        'ValueChangedFcn',@rmsUpdate,...
        'Position',[controlTabWidth*0.22-(30/2) controlTabHeight*0.4 40 20],...
        'HorizontalAlignment','Center');
    cutoffText = uilabel('Parent',controlTab,...
        'Text',strcat("Noise Threshold: ",num2str(noiseThreshold)," pA"),...
        'Position',[controlTabWidth*0.15-(175/2) controlTabHeight*0.325 175 20],...
        'fontweight', 'bold',...
        'HorizontalAlignment','Center');
    ...
    uilabel('Parent',controlTab,...
        ...
        'fontweight', 'bold',...
        'HorizontalAlignment','Center',...
        'Position',[controlTabWidth*0.38-(120/2) controlTabHeight*0.4 120 20]);
    decayField = uieditfield(controlTab,...
        'numeric',...
        'Value',decayPercent,...
        'ValueChangedFcn',@fieldUpdate,...
        'Position',[controlTabWidth*0.335-(30/2) controlTabHeight*0.325 30 20],...
        'HorizontalAlignment','Center');
    uilabel('Parent',controlTab,...
        'Text','% of Peak',...
        'fontweight', 'bold',...
        'HorizontalAlignment','Center',...
        'Position',[controlTabWidth*0.405-(70/2) controlTabHeight*0.325 70 20]);
    ...
    uilabel('Parent',controlTab,...
        ...
        'fontweight', 'bold',...
        'HorizontalAlignment','Center',...
        'Position',[controlTabWidth*0.57-(110/2) controlTabHeight*0.4 110 20]);
    samplingField = uieditfield(controlTab,...
        'numeric',...
        'Value',samplesPerMilliSecond,...
        'ValueChangedFcn',@fieldUpdate,...
        'Position',[controlTabWidth*0.545-(30/2) controlTabHeight*0.325 30 20],...
        'HorizontalAlignment','Center');
    uilabel('Parent',controlTab,...
        'Text','kHz',...
        'fontweight', 'bold',...
        'HorizontalAlignment','Center',...
        'Position',[controlTabWidth*0.595-(30/2) controlTabHeight*0.325 30 20]);
    ...
    uilabel('Parent',controlTab,...
        ...
        'fontweight', 'bold',...
        'HorizontalAlignment','Center',...
        'Position',[controlTabWidth*0.81-(200/2) controlTabHeight*0.4 200 20]);
    preEventField = uieditfield(controlTab,...
        'numeric',...
        'Value',preEventSamples,...
        'ValueChangedFcn',@sampleNumberUpdate,...
        'Position',[controlTabWidth*0.80-(30/2) controlTabHeight*0.325 30 20],...
        'HorizontalAlignment','Center');
    uilabel('Parent',controlTab,...
        'Text','Pre Event',...
        'fontweight', 'bold',...
        'HorizontalAlignment','Center',...
        'Position',[controlTabWidth*0.72-(50/2) controlTabHeight*0.325 60 20]);
    postEventField = uieditfield(controlTab,...
        'numeric',...
        'Value',postEventSamples,...
        'ValueChangedFcn',@sampleNumberUpdate,...
        'Position',[controlTabWidth*0.92-(30/2) controlTabHeight*0.325 30 20],...
        'HorizontalAlignment','Center');
    uilabel('Parent',controlTab,...
        'Text','Decay',...
        'fontweight', 'bold',...
        'HorizontalAlignment','Center',...
        'Position',[controlTabWidth*0.865-(50/2) controlTabHeight*0.325 50 20]);    
    ...
    uibutton('Parent',controlTab,...
        ...
        'fontweight', 'bold',...
        'Position',[controlTabWidth*0.2-(100/2) controlTabHeight*0.1 100 40]);
    uibutton('Parent',controlTab,...
        'Text',sprintf('%s\n%s','Load Existing','Analysis'),...
        'ButtonPushedFcn',@resumeAnalysis,...
        'fontweight', 'bold',...
        'Position',[controlTabWidth*0.4-(100/2) controlTabHeight*0.1 100 40]);
    uibutton('Parent',controlTab,...
        'Text',sprintf('%s\n%s','Save','Analysis'),...
        'ButtonPushedFcn',@saveAnalysis,...
        'fontweight', 'bold',...
        'Position',[controlTabWidth*0.6-(100/2) controlTabHeight*0.1 100 40]);  
    uibutton('Parent',controlTab,...
        'Text','Exit',...
        'ButtonPushedFcn',@exitAnalysis,...
        'fontweight', 'bold',...
        'Position',[controlTabWidth*0.8-(100/2) controlTabHeight*0.1 100 40]); 
...
%% create analysis tab
    ...
    zoomCheck = uicheckbox('Parent',analysisTab,...
        'Text','Auto-zoom on event selection',...
        'fontweight','bold',...
        'Value',1,...
        'ValueChangedFcn',@fieldUpdate,...
        'Position',[controlTabWidth*0.5-(200/2) controlTabHeight*0.96-(40) 200 20]);
    
    %buttons for zooming in and out
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Zoom Out','X [1]'),...
        'ButtonPushedFcn',@expandXView,...
        'Position',[controlTabWidth*0.2-(100/2) controlTabHeight*0.8-(40) 100 40],...
        'fontweight', 'bold');
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Zoom In','X [2]'),...
        'ButtonPushedFcn',@shrinkXView,...
        'Position',[controlTabWidth*0.4-(100/2) controlTabHeight*0.8-(40) 100 40],...
        'fontweight', 'bold');
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Zoom Out','Y [3]'),...
        'ButtonPushedFcn',@expandYView,...
        'Position',[controlTabWidth*0.6-(100/2) controlTabHeight*0.8-(40) 100 40],...
        'fontweight', 'bold');
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Zoom In','Y [4]'),...
        'ButtonPushedFcn',@shrinkYView,...
        'Position',[controlTabWidth*0.8-(100/2) controlTabHeight*0.8-(40) 100 40],...
        'fontweight', 'bold');
    ...
    uibutton('Parent',analysisTab,...
        ...
        'Position',[controlTabWidth*0.2-(100/2) controlTabHeight*0.6-(40) 100 40],...
        'fontweight', 'bold');
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Threshold Shift','Forward [w]'),...
        'ButtonPushedFcn',@forwardThreshold,...
        'Position',[controlTabWidth*0.4-(100/2) controlTabHeight*0.6-(40) 100 40],...
        'fontweight', 'bold');
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Peak Shift','Back [e]'),...
        'ButtonPushedFcn',@backPeak,...
        'Position',[controlTabWidth*0.6-(100/2) controlTabHeight*0.6-(40) 100 40],...
        'fontweight', 'bold');
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Peak Shift','Forward [r]'),...
        'ButtonPushedFcn',@forwardPeak,...
        'Position',[controlTabWidth*0.8-(100/2) controlTabHeight*0.6-(40) 100 40],...
        'fontweight', 'bold');
    ...
    uibutton('Parent',analysisTab,...
        ...
        'Position',[controlTabWidth*0.2-(100/2) controlTabHeight*0.4-(40) 100 40],...
        'fontweight', 'bold');
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Amplitude','Sort [s]'),...
        'ButtonPushedFcn',@addToAmplitudeGroup,...
        'Position',[controlTabWidth*0.4-(100/2) controlTabHeight*0.4-(40) 100 40],...
        'fontweight', 'bold');
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Frequency','Sort [d]'),...
        'ButtonPushedFcn',@addToFrequencyGroup,...
        'Position',[controlTabWidth*0.6-(100/2) controlTabHeight*0.4-(40) 100 40],...
        'fontweight', 'bold');
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Delete Event','[f]'),...
        'ButtonPushedFcn',@deleteEvent,...
        'Position',[controlTabWidth*0.8-(100/2) controlTabHeight*0.4-(40) 100 40],...
        'fontweight', 'bold');
    ...
    uibutton('Parent',analysisTab,...
        ...
        'Position',[controlTabWidth*0.2-(100/2) controlTabHeight*0.2-(40) 100 40],...
        'fontweight', 'bold');
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Next Window','[x]'),...
        'ButtonPushedFcn',@nextWindow,...
        'Position',[controlTabWidth*0.4-(100/2) controlTabHeight*0.2-(40) 100 40],...
        'fontweight', 'bold');
    
    % misc. buttons
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Plot','Avg. Trace'),...
        'ButtonPushedFcn',@plotOverlaidEvents,...
        'Position',[controlTabWidth*0.6-(100/2) controlTabHeight*0.2-(40) 100 40],...
        'fontweight', 'bold');
    uibutton('Parent',analysisTab,...
        'Text',sprintf('%s\n%s','Update','Measurements'),...
        'ButtonPushedFcn',@updateMeasurements,...
        'Position',[controlTabWidth*0.8-(100/2) controlTabHeight*0.2-(40) 100 40],...
        'fontweight', 'bold');
...
%% UI buttons
    ...
    % increase the x-range of the viewing window by a consistent factor
        ...
        if (currentWindow(1) <= viewScopeDiff)
    ...
    % add event to group in which the full event is measured
        ...
        eventPeakValue = traceSamples(eventPeakTime,traceValueCol);
        eventThresholdValue = traceSamples(eventThresholdTime,traceValueCol);
        if (abs(eventPeakValue) - abs(eventThresholdValue)) < noiseThreshold
...
%                 addToFrequencyGroup;
    ...
    % plots raw events and scaled events for removal from average trace
        ...
        % clera plots and plot average trace
        cla(allTracePlot);
        cla(scaledTracePlot);
        plotAverageEvent;
...
%% helper functions
    ...
    % add values to list boxes on the control tab
        ...
        for i = 1:(size(filelist,1))
            traceliststrings(i) = convertCharsToStrings(filelist.name);
        end
    ...
    function fitAverageEvent
    % fits a single exponential to the decay of the average event trace    
        ...
        for i = 1:((totalSamples + 1) - averageTraceMinIndex)
            averageTraceDecayArray(100*i-99:100*i,1) =...
                linspace(...
                averageTrace(averageTraceMinIndex+(i-1),1),...
                averageTrace(averageTraceMinIndex+i,1));
        end
        
        % generate logical array for values that are in the 80-20 range of the decay
        for i = 1:size(averageTraceDecayArray,1)
            averageTraceDecayLogical(i,1) =...
                ((averageTraceMinVal*0.8) < averageTraceDecayArray(i,1))...
                && (averageTraceDecayArray(i,1) < (averageTraceMinVal*0.2));
        end
        
        % create 80-20 decay array
        averageTraceDecayArray2080 = averageTraceDecayArray(averageTraceDecayLogical,1);
        averageTraceDecayArray2080(:,2) = (1:length(averageTraceDecayArray2080))/1000;
        
        % fit single exponential decay to 80-20 array
        [fitobj,gof] =...
            fit(averageTraceDecayArray2080(:,2),averageTraceDecayArray2080(:,1),'exp1','StartPoint',[0 -1]);
